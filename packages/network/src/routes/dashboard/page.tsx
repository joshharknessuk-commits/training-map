  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-3xl border border-neutral-200 bg-white/70 p-5 shadow-glow">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">
            Upcoming open mats
          </p>
          <ul className="mt-4 space-y-4">
            {dashboard.upcomingOpenMats.map((mat) => (
              <li key={mat.id} className="rounded-2xl border border-white/5 bg-neutral-50 p-4">
                ...
                <p className="text-sm text-neutral-700">{mat.gymName}</p>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="rounded-3xl border border-neutral-200 bg-white/70 p-5 shadow-glow">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">
          Gym payouts
        </p>
          ...
          {dashboard.payouts.map((payout) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <p className="text-xs uppercase tracking-[0.3em] text-neutral-600">{payout.status}</p>
              </div>
            </div>
          ))}
        </div>
