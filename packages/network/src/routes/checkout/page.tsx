  ...
  if (!tier || tier.id === 'academy') {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
        ...
        <p className="mt-2 text-neutral-700">Please select a valid membership tier.</p>
        <Link
  ...
  return (
    <div className="mx-auto max-w-lg space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-neutral-700">{tier.description}</p>
      </div>
      ...
      <div className="text-center">
        <Link href="/network#membership" className="text-sm text-brand-500 hover:text-brand-600">
