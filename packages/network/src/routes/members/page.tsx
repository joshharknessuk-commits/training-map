...
export default function MembersPage() {
  return (
    <div className="space-y-10 rounded-3xl border border-neutral-200 bg-[#05070b] p-10 shadow-[0_25px_70px_rgba(0,0,0,0.5)]">
      <div className="space-y-3 text-left">
        <p className="text-xs font-semibold uppercase tracking-[0.5em] text-brand-600">Members</p>
        ...
        <p className="text-xs text-neutral-600">Built to strengthen grappling communities—not centralise them.</p>
      </div>
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-3 sm:grid-cols-3 text-sm text-slate-200">
          {[
            ...
            <div key={step.title} className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-3">
              <p className="text-[0.6rem] font-semibold uppercase tracking-[0.4em] text-brand-600">{step.title}</p>
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2 text-sm text-slate-200">
          {MEMBER_FAQ.map((item) => (
            <details key={item.question} className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-3">
