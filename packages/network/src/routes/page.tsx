  ...
  return (
    <div className="space-y-24">
      <section className="space-y-4 fade-in-up bg-[#0c1116] px-6 py-10 rounded-3xl border border-white/5">
        ...
        <p className="text-sm text-neutral-700">Live data keeps members and gyms synced.</p>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 fade-in-up">
        <NetworkStatCard
          ...
          icon={<span className="text-brand-500">◎</span>}
      ...
      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-[#0f0d12]/90 px-6 py-10 text-left shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
        <p className="text-xs font-semibold uppercase tracking-[0.4em] text-brand-600">Network philosophy</p>
      ...
      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-[#0f151b] p-10 shadow-[0_20px_60px_rgba(15,23,42,0.55)] backdrop-blur transition duration-300 hover:bg-white/80">
        <div className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">
            How it works
          </p>
          <h2 className="text-2xl font-semibold tracking-tight text-neutral-900">End-to-end flow</h2>
          <p className="text-sm text-neutral-700">Scan → verify → payout. Nothing else to wire up.</p>
        </div>
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {HOW_IT_WORKS.map((step) => (
            <div
              key={step.title}
              className="rounded-2xl border border-neutral-200 bg-neutral-50/60 p-4 transition duration-200 hover:-translate-y-1 hover:border-neutral-300"
            >
              <p className="text-[0.65rem] font-semibold uppercase tracking-[0.4em] text-brand-600">
                {step.title}
              </p>
      ...
      <section id="membership" className="space-y-6 fade-in-up rounded-3xl border border-white/5 bg-[#0c1116] px-6 py-10">
        <div className="flex flex-col gap-3 text-left">
          ...
          <p className="text-sm text-neutral-700">Member tiers ship ready-to-train access and perks.</p>
          <div className="rounded-2xl border border-neutral-200 bg-neutral-50/60 p-6">
            <p className="text-xs uppercase tracking-[0.35em] text-brand-600">Member benefits</p>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-200">
              {MEMBER_BENEFITS.map((benefit) => (
                <li key={benefit}>{benefit}</li>
              ))}
            </ul>
            <p className="mt-3 text-xs text-neutral-600">For gyms, see the Academy plan below.</p>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-neutral-300 bg-neutral-50/60 p-5 text-sm text-slate-200">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-700">Transparent pricing. Upgrade or pause anytime.</p>
          </div>
          <Link
      ...
      {academyTier ? (
        <section id="academy" className="fade-in-up grid gap-6 rounded-3xl border border-neutral-200 bg-[#0f151b] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.45)] md:grid-cols-2">
          <div className="space-y-3 text-left">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">
              For gyms
            </p>
            <h2 className="text-2xl font-semibold text-neutral-900">Academy plan</h2>
            <p className="text-sm text-neutral-700">Built for gyms that need payouts, not spreadsheets.</p>
      ...
      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-[#0c1116]/90 p-8 shadow-[0_25px_70px_rgba(0,0,0,0.45)]">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">Auto payouts</p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
          {[
            ...
            <div key={node.title} className="flex items-center gap-3 text-left">
              ...
              {index < 3 ? <span className="text-brand-500 text-xl" aria-hidden="true">→</span> : null}
            </div>
          ))}
        </div>
      </section>

      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-gradient-to-br from-[#0c141b] via-emerald-900/30 to-slate-950 p-10 shadow-[0_25px_80px_rgba(6,78,59,0.45)]">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">QR verification</p>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          <div className="rounded-xl border border-neutral-200 bg-neutral-50/70 p-3 text-left text-neutral-900">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.5em] text-brand-600">Step 1</p>
          ...
          <div className="rounded-xl border border-neutral-200 bg-neutral-50/70 p-3 text-left text-neutral-900">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.5em] text-brand-600">Step 2</p>
          ...
          <div className="rounded-xl border border-neutral-200 bg-neutral-50/70 p-3 text-left text-neutral-900">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.5em] text-brand-600">Step 3</p>
      ...
      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-white/70 p-8 shadow-[0_25px_70px_rgba(0,0,0,0.5)]">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-[2rem] border border-neutral-300 bg-neutral-50/70 p-5 text-left text-neutral-900 shadow-[0_20px_40px_rgba(0,0,0,0.45)]">
            <p className="text-xs uppercase tracking-[0.45em] text-brand-600">Staff tablet</p>
            <div className="mt-3 rounded-xl border border-neutral-200 bg-white/60 p-4">
              <div className="flex items-center justify-between text-sm">
                <span>Check-in</span>
                <span className="rounded-full bg-brand-500/20 px-3 py-1 text-xs text-brand-600">Verified ✓</span>
              </div>
              <p className="mt-2 text-2xl font-semibold">J. Carvalho</p>
              <p className="text-xs text-neutral-600">Network Pro · expires in 27 days</p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 rounded-[2rem] border border-neutral-300 bg-neutral-50/70 p-5 shadow-[0_20px_40px_rgba(0,0,0,0.45)]">
            <p className="text-xs uppercase tracking-[0.45em] text-brand-600">Rotating QR</p>
            ...
            <p className="text-xs text-neutral-600">Regenerates every 60 minutes. Device-bound.</p>
          </div>
        </div>
      </section>

      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-[#0f151b] p-8 shadow-[0_20px_70px_rgba(0,0,0,0.5)]">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">Try it now</p>
      ...
      <section className="fade-in-up rounded-3xl border border-neutral-200 bg-[#0c1116]/90 p-8 shadow-[0_25px_70px_rgba(0,0,0,0.45)]">
        ...
        <p className="mt-1 text-sm text-neutral-700">Quick hits from what’s shipping next.</p>
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          {['Gym-facing analytics', 'Smart retention metrics', 'Automated guest passes', 'Stripe payouts beta'].map(
            (item) => (
              <div key={item} className="rounded-2xl border border-neutral-200 bg-neutral-50/60 p-4 text-neutral-900">
                <p className="text-sm font-semibold">{item}</p>
                <p className="text-xs text-neutral-700">Shipping soon</p>
              </div>
            ),
          )}
        </div>
      ...
      <footer className="rounded-3xl border border-neutral-200 bg-white/60 p-6 text-center text-sm text-neutral-700">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-600">
          GrappleMap Network
        </p>
        <p className="mt-2 text-base text-neutral-900">A single domain powering maps + access + payouts.</p>
        <p className="mt-1 text-xs text-neutral-600">Built on GrappleMap.uk. All rights reserved.</p>
      </footer>
    </div>
  );
}
